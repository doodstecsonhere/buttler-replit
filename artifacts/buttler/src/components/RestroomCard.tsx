    ...
    >
      ...
      <div className="flex justify-between items-start gap-3">
        ...
        <button
          ...
          className="flex-shrink-0 flex flex-col items-center justify-center w-12 h-12 rounded-xl bg-primary/10 text-primary hover:bg-primary/90 hover:text-primary-foreground active:opacity-100 transition-colors duration-75"
